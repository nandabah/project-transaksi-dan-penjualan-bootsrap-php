                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page"
                                    href="../karyawan/karyawan.php">karyawan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page"
                                        ...
                                        <tbody>
                                           ...
                                           $where =  $row['id_transaksi'];
                                                ...
                                                if (mysqli_num_rows($result2) === 0) {
                                                    mysqli_query($koneksi,"DELETE FROM `transaksi` WHERE `transaksi`.`id_transaksi` =$where");
                                                }
             ...
             <div class="row mb-4">
                ...
                <button type="button" class=" btn btn-success "
                        ...
                        function myFunctions() {
                            ...
                            if (confirm(text) == true) {
                                document.getElementById("selesai").value = 52132134;
                                ...
                                <!-- /button modal -->
                                    ...
                                    <button class="btn btn-primary" id="selesai" name="selesai" onclick="myFunctions()" type="submit"
