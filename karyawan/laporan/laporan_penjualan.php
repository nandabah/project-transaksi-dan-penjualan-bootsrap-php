...
// var_dump($_POST);
        ...
        <div class="row mt-5 px-3 pt-4 " style="margin:0; min-height : 100vh;">
                ...
                <form action="#" method="POST"  class="noPrint">
                   ...
                   <div class="col-12 col-md-2">
                       ...
                       <div class="form-floating">
                           <input type="text" autocomplete="off" name="datefirst" class="datepicker_input form-control border-2" id="datepicker1"  placeholder="DD/MM/YYYY" />
                    ...
                    <div class="form-floating  ">
                    <input type="text"  autocomplete="off" name="datesecond" class="datepicker_input form-control border-2" id="datepicker1"  placeholder="DD/MM/YYYY" />
                    <label for="datepicker1">Tanggal kedua</label>
                     ...
                     <div class="col-12 col-md-2 ">
                        <div class="form-floating mb-4 ">
                            <input type="text"  autocomplete="off"  name="nama_pegawai"  class=" form-control border-2" id="datepicker1"  placeholder="DD/MM/YYYY" />
